var coreFunctions = new coreFunctions();
...
var getHeroReward = function(whatHero, faction) {
    var reward = '',
        reCalc = Math.floor(Math.random() * 100);
    switch (true) {
        case (faction === 'alliance' && whatHero === 'five-hero'):
            reward = returnHero(allianceFiveHeroes);
            break;
        case (faction === 'horde' && whatHero === 'five-hero'):
            reward = returnHero(hordeFiveHeroes);
            break;
        case (faction === 'elves' && whatHero === 'five-hero'):
            reward = returnHero(elvesFiveHeroes);
            break;
        case (faction === 'undead' && whatHero === 'five-hero'):
            reward = returnHero(undeadFiveHeroes);
            break;
        case (faction === 'heaven-hell' && whatHero === 'five-hero'):
            reward = returnHero(heavenHellFiveHeroes);
            if (reCalc >= 45) {
                do {
                    reward = returnHero(heavenHellFiveHeroes);
        ...
        case (faction === 'alliance' && whatHero === 'four-hero'):
            reward = returnHero(allianceFourHeroes);
            break;
        case (faction === 'horde' && whatHero === 'four-hero'):
            reward = returnHero(hordeFourHeroes);
            break;
        case (faction === 'elves' && whatHero === 'four-hero'):
            reward = returnHero(elvesFourHeroes);
            break;
        case (faction === 'undead' && whatHero === 'four-hero'):
            reward = returnHero(undeadFourHeroes);
            break;
        case (faction === 'heaven-hell' && whatHero === 'four-hero'):
            reward = returnHero(heavenHellFourHeroes);
            if (reCalc >= 40) {
                do {
                    reward = returnHero(heavenHellFourHeroes);
                } while (reward.includes('heaven'));
